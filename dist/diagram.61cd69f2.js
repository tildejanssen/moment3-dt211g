...
})({"cKijX":[function(require,module,exports) {
...
fetch("https://studenter.miun.se/~mallar/dt211g/").then((response)=>response.json()).then((data)=>{
...
},{}]},["cKijX","7ophb"], "7ophb", "parcelRequire5feb")
